...
export default {
    data() {
        return {
            shoppingList: []  // Initialize as an empty array
        };
    },
    created() {
        ...
        <div class="container my-5 my-bg-pic">
            <div class="row p-4 pe-lg-5 pt-lg-5 align-items-center rounded-3 border shadow-lg">
                <div class="col-lg-12 p-3 p-lg-12 pt-lg-12">
                    ...
                    <br>
                    <hr>
                    <p class="h3 lh-1 pb-2 text-secondary">付款方式</p>
                    <br>
                    <div>
                        <div class="row py-3 justify-content-between ps-0 ps-lg-5">
                            <div class="pb-5">
                                <label class="h5">
                                    <input for="optionsRadios1" type="radio" name="optionsRadios" id="optionsRadios1"
                                        value="option1" checked>
                                    &nbsp;信用卡付款
                                </label>
                                <hr>
                                <label class="h5">
                                    <input for="optionsRadios2" type="radio" name="optionsRadios" id="optionsRadios2"
                                        value="option2">
                                    &nbsp;網路ATM
                                </label>
                                <hr>
                                <label class="h5">
                                    <input for="optionsRadios3" type="radio" name="optionsRadios" id="optionsRadios3"
                                        value="option3">
                                    &nbsp;超商代碼
                                </label>
                        ...
                        <p class="h3 lh-1 pb-2 text-secondary">運送方式</p>
                        <br>
                        <div>
                            <div class="row py-3 justify-content-between ps-0 ps-lg-5">
                                <div class="pb-5">
                                    <label class="h5">
                                        <input for="optionsRadios4" type="radio" name="optionsRadios1"
                                            id="optionsRadios4" value="option1" checked>
                                        &nbsp;黑貓宅配
                                    </label>
                                    <hr>
                                    <label for="optionsRadios5" class="h5">
